...
public class DriverUtils {
	...
	FileNotFoundException, Exception {
		...
		desiredCapabilities.setCapability("username", "landmarkgroup");
		desiredCapabilities.setCapability("accessKey", "3b8bdb66-45d3-4b4b-a4ee-2724e401a106");
		desiredCapabilities.setCapability("name", "Jena Test");
